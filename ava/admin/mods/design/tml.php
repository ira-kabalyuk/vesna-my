<?
$htm->external("EXT_ADD",CMS_RUL_TPL."tpl.tpl");
$htm->assign('TITLE','Шаблоны '.SKIN);
$men=array();
...
function kont_menu(){
global $htm, $arm;
$dir=$_SERVER["DOCUMENT_ROOT"]."/templ/".substr(SKIN,0,strlen(SKIN)-1);
