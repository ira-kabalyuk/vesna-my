...
<div><button class="btn btn-primary"  id="but-add">добавить новый</button></p>
</div>
<div id="newslist">
...
<div class="mt20"></div>
	<div class="mt20"> <input type="text" name="title" class="w400" placeholder="Название Блога" ></div>
<div class="mt20">
...
pageSetUp();
	...
	$(function() {
		...
		$('#add-new-dialog').dialog({ 
			title:"Добавление нового блога",
			width:450,
			height:150
		});
	});
		Smart.dataTable({ table:"#ul_newslist",modlink:"{MOD_LINK}",dataurl:"{MOD_LINK}&act=get_data" });
