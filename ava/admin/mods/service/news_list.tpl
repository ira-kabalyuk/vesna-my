...
<div><button class="btn btn-primary"  id="but-add">добавить услугу</button></p>
</div>
<div id="newslist">
...
<div class="mt20"></div>
	<div class="mt20"> <input type="text" name="title" class="w400" placeholder="Название услуги" ></div>
<div class="mt20">
