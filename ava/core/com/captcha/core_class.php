...
class Com_captcha_core {
	...
	*/	
	function __construct($length = '', $size = '', $type = '', $captchaType = '', $dotsPercent = 10) {
	   
        $this->font=dirname(__FILE__)."/fonts/arial.ttf";
        $this->fonts_folder = dirname(__FILE__).'/fonts/';
        if(!is_file($this->font)) echo "not found file ".$this->font;
