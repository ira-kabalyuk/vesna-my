...
<option value="dirs">Ссылка на справочник</option>
...
$(function(){
	var TPL={
		...
		'dirs':'<select name="dirs">{DIRS}</select>',
		'img':'<span>каталог:<input type="text" class="w200" name="path" value="{path}" /><span>ширина <input type="text" name="w" class="w100" value="{w}"></span><span> высота<input type="text" name="h" class="w100" value="{h}"></span>'
	};
